// <![CDATA[
var colours=new Array("#ffadea", "#ff5ecb", "#ff5ecb", "#ffadea", "#ffe3f7"); // colours for top, right, bottom and left borders and background of bubbles
...
function createDiv(height, width) {
  ...
  // Explicitly set dimensions as styles
  ...
  // FORCE the div to contain absolutely nothing
  div.textContent = ""; 
  div.innerHTML = "";
